...
class RecyclerViewAdapterSuccessWeekCalendar(private val calendarLayout: LinearLayout, val date: Date) : RecyclerView.Adapter<RecyclerViewAdapterSuccessWeekCalendar.CalendarItemHolder>() {
